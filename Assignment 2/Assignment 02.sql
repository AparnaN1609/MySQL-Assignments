...
SELECT SUM(salary) AS Total_Finance_Salary FROM Employees WHERE department_id = 7;
...
SELECT     d.department_id, d.department_name,     COUNT(e.employee_id) AS Employee_Count FROM Departments d LEFT JOIN Employees e     ON d.department_id = e.department_id GROUP BY d.department_id, d.department_name;
SELECT l.location_id, l.location,    e.employee_name FROM Employees e RIGHT JOIN Location l    ON e.location_id = l.location_id;
SELECT l.location_id, l.location, e.employee_name FROM Employees e RIGHT JOIN Location l ON e.location_id = l.location_id;
INSERT INTO location (location) VALUES
('Chennai'),
('Bangalore'),
...
SELECT * FROM Location;DELETE FROM location WHERE location IS NULL;
